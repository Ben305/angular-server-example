...
angular.module('angular-meteor')
  ...
  .run(['$injector', '$q', function($injector, $q) {
    ...
    /**
	 * Patch to make angular-server testable. When angular is setup again and again by unit or integration tests
	 ...
	 *
	 * @author Boris Feldmann <boris.feldmann_nospam@werkdigital.de>
	 * @date 2016-01-27
	 */
